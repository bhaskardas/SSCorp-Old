...
INSERT INTO sscorp_companyProfile_m(company_id, company_name, founder_name, co_founders_name, present_CEO, company_phone, email_id, company_logoAttachName, company_punchLine, about_us, fax_number, infrastructure, achievments_desc, projects_desc)
  VALUES(1, 'Super Sales Corporation', 'Rakesh Kumar Jain', 'Rajesh Kumar Jain', 'Rakesh Kumar Jain', '+91-11-23860884', 'supsalcorp@gmail.com', 'logo.jpg', NULL, '</p>M/s Super Sales Corporation is one of the largest distributors and manufacturers in conduit accessories in both MS and GI forms.</p>

<p>Super Sales Corporation was established 30 years ago in 1979 with one crystal clear vision in mind; to produce quality products and with in depth knowledge of our mentors Mr. RAKESH KUMAR JAIN & Mr. RAJEEV KUMAR JAIN, we have grown leaps and bounce in the industry. Experience, hard work and willingness to go out of the box have been our success mantra.</p>
...
<p>Super Sales Corporation today distributes and manufacture all sizes under 17 major product groups and has now taken its footsteps far ahead in the industry by supplying to Big Brands like Larsen & Tubro Ltd., ABB, ETA, B.E.Contracts Pvt. Ltd., Consotium of Sudhir Gensets & Power Projects Pvt. Ltd., Sterling & Wilson, Bluestar India, Ahluwalia Contracts Pvt. Ltd. etc as an approved Vendor with capability of onsite delivery at any location. It also caters to most of the big retail counters in top 6 cities of the country and plans to expand nationwide retail distribution by end of 2010.</p>', '+91-11-23862056', '<p>Our manufacturing and distribution facilities are spread over wide area in Sahibabad Industrial Area, Site IV with all the skilled and experienced labor involved in the process and storage facility in Shahdra, Delhi.</p>
