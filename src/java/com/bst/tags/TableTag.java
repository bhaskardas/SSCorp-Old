 ...
 * @version $Revision: 1.4 $ ($Author: anshul.agarwal $)
 */
public class TableTag extends org.displaytag.tags.TableTag
{
    ...
    /**
     * JS function for Href.
     */
    private String jsHref;
    ...
    /**
     * setter for the "jsHref" attribute. 
     * @param value JS function for creating links
     */
    public void setJsHref(String value)
    {
        this.jsHref = value;
    }
    ...
    {
        // construct Href from base href, preserving parameters
        Href href = null;
        if (jsHref == null)
        	href = new Href(this.baseHref);
        else
        	href = new JavascriptHref(this.baseHref, this.jsHref);
    ...
    private void writeSearchResultAndNavigation()
    {
        ...
        {
            // create a new href
        	Href navigationHref = null;
        	if (jsHref == null)
        		navigationHref = new Href(this.baseHref);
        	else
        		navigationHref = new JavascriptHref(this.baseHref, this.jsHref);
