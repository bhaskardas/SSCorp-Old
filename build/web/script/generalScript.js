...
/**
 * function to determine the menu to be displayed when clicked on footer links.
 */
function showMenu4mFooter(contextPath, menuUrl, currentMenuName) {
    document.footerForm.action = contextPath + menuUrl;
    document.footerForm.currentMenuName.value = currentMenuName;
